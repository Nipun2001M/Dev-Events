...
export async function POST(req:NextRequest){
    try{
        ...
        return NextResponse.json({message:"event creted sucessfully",event:createdEvent},{status:201})
...
export async function GET(){
    try{
        ...
        return NextResponse.json({message:"Events Fetched Sucessfully",events},{status:200})
